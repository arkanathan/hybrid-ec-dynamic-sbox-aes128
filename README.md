...
Implementasi Java pembangkitan **dynamic S-box** untuk AES-128 berbasis kurva eliptik, membandingkan empat rancangan **official** (Bab 4): baseline statis, baseline EC shuffle-only, **CBPE**, dan **KDFP**.
